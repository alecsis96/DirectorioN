                              ...
                              <div className="grid grid-cols-3 gap-2">
                                ...
                                {(business.location?.lat && business.location?.lng) && (
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="bg-amber-500 text-white px-3 py-2 rounded-lg text-xs font-semibold hover:bg-amber-600 transition shadow-md flex items-center justify-center gap-1"
                                  >
