    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50 text-gray-800 font-sans">
      ...
      <section className="max-w-6xl mx-auto px-6 py-10">
        ...
        {!uiFilters.category && !uiFilters.query && !uiFilters.colonia && (
          <>
            {(() => {
              const sponsored = businesses.filter(b => b.plan === 'sponsor').slice(0, 1);
              
              if (sponsored.length === 0) return null;
              
              const business = sponsored[0];
              
              return (
                <div className="mb-8 relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-600 via-pink-500 to-red-500 p-1 shadow-2xl">
                  <div className="bg-white rounded-[20px] p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div className="bg-gradient-to-br from-purple-500 to-pink-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg flex items-center gap-2">
                          <span>👑</span>
                          PATROCINADO
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 items-center">
                        ...
                        <div className="flex flex-wrap items-center gap-2 mb-4">
                          ...
                          {business.rating && business.rating > 0 && (
                            <span className="inline-flex items-center gap-1 px-3 py-1 bg-yellow-100 text-yellow-800 text-sm font-semibold rounded-full">
                              ⭐ {business.rating.toFixed(1)} Excelente
                            </span>
                          )}
                      ...
                      <div className="flex flex-col gap-3">
                        <button
                          ...
                          className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-4 rounded-xl font-bold text-lg hover:from-purple-700 hover:to-pink-700 transition shadow-lg flex items-center justify-center gap-2"
                        >
                          <span>👀</span>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          {business.WhatsApp && (
                            <a
                              ...
                              className="bg-green-500 text-white px-4 py-3 rounded-lg font-semibold hover:bg-green-600 transition shadow-md flex items-center justify-center gap-2"
                            >
                          ...
                          {business.phone && (
                            <a
                              ...
                              className="bg-blue-500 text-white px-4 py-3 rounded-lg font-semibold hover:bg-blue-600 transition shadow-md flex items-center justify-center gap-2"
                            >
                              <span>📞</span>
                              Llamar
                            </a>
